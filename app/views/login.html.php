...
<div class="page">
  ...
  <section class="panel-right">
    ...
    <form method="POST" action="http://localhost:5001/">
      ...
      <div class="input-wrap">
        ...
        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($oldEmail ?? '', ENT_QUOTES); ?>" placeholder="vous@etablissement.sn" required>
      </div>
      ...
      <a class="btn-submit" type="submit" methode="POST" href="http://localhost:5001/accueil">
        Se connecter
