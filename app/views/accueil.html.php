...
$moyeneClasse = $moyeneClasse ?? null;
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .btn-seconds{background:var(--red);}
...
<header class="topbar">
  ...
  <div class="top-right">
    <div class="year-pill"><span class="dot"></span><?= htmlspecialchars($anneeCourant['nom'] ?? '') ?></div>
    ...
    <div class="user">
      ...
      <div class="user-meta">
        ...
        <a href="http://localhost:5001" class="btn btn-seconds" style="text-decoration: none; color:whitesmoke">Déconnexion</a>
     </div>
  </div>
</header>
...
<div class="page">
  ...
  <form class="filters-card" id="filtersCard" method="POST" action="/accueil">
        <div class="field">
            ...
            <div class="select-wrap">
                ...
                <option> <?php echo $classe['nomclasse']?> </option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="stat-value" id="classAvg"><span><?php echo $moyeneClasse !== null ? number_format($moyeneClasse, 2) : '--'; ?></span><span>/20</span></div>
        </div>
  </form>
